...
with st.sidebar:
    selected = option_menu(
        ...
        options=["Home", "Classify", "Model Insights", "About"],
...
if selected == "Home":
    ...
    with col2:
        ...
        video_path = "X:/Guviprojects/projectsss/5548030-uhd_3840_2160_25fps.mp4"  # Replace with your video file
        st.video(video_path)
...
if selected == "Classify":
    ...
    if uploaded_file is not None:
        ...
        model_path = "X:/Guviprojects/projectsss/mobilenet_fish_final.keras"
...
train_path = "X:/Guviprojects/projectsss/images.cv_jzk6llhf18tm3k0kyttxz/data/train"
val_path = "X:/Guviprojects/projectsss/images.cv_jzk6llhf18tm3k0kyttxz/data/val"
...
if selected == "About":
    ...
    with col2:
        # Space for an Image
        st.image("X:/Guviprojects/projectsss/images.cv_jzk6llhf18tm3k0kyttxz/data/train/fish sea_food shrimp/0D12108M3GQA.jpg", caption="Fish Classification Model", use_container_width=True)
